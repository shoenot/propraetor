...
(function () {
    ...
    function initAll(root) {
        ...
        containers.forEach(function (container) {
            ...
            // (it sits between the clear button and the search icon)
            searchInput.style.paddingRight = '56px';

            // Move clear button a bit further right to not overlap
            var clearBtn = container.querySelector('.ss-clear');
            if (clearBtn) {
                clearBtn.style.right = '54px';
            }
